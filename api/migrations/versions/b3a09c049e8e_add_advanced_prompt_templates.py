...
def upgrade():
    ...
    with op.batch_alter_table('app_model_configs', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('chat_prompt_config', sa.JSON(), nullable=True))
        batch_op.add_column(sa.Column('completion_prompt_config', sa.JSON(), nullable=True))
        batch_op.add_column(sa.Column('dataset_configs', sa.JSON(), nullable=True))
