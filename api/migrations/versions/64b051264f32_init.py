...
def upgrade():
    ...
    op.create_table('accounts',
                    ...
                    sa.Column('status', sa.String(length=16), server_default=sa.text("'active'::character varying"),
                              nullable=False),
    ...
    op.create_table('app_model_configs',
                    ...
                    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP(0)'),
                              nullable=False),
                    sa.Column('opening_statement', sa.JSON(), nullable=True),
                    sa.Column('suggested_questions', sa.JSON(), nullable=True),
                    sa.Column('suggested_questions_after_answer', sa.JSON(), nullable=True),
                    sa.Column('more_like_this', sa.JSON(), nullable=True),
                    sa.Column('model', sa.JSON(), nullable=True),
                    sa.Column('user_input_form', sa.JSON(), nullable=True),
                    sa.Column('pre_prompt', sa.JSON(), nullable=True),
    ...
    op.create_table('apps',
                    ...
                    sa.Column('status', sa.String(length=255), server_default=sa.text("'normal'::character varying"),
                              nullable=False),
    ...
    op.create_table('conversations',
                    ...
                    sa.Column('override_model_configs', sa.JSON(), nullable=True),
                    sa.Column('model_id', sa.String(length=255), nullable=False),
                    sa.Column('mode', sa.String(length=255), nullable=False),
                    sa.Column('name', sa.String(length=255), nullable=False),
    ...
    op.create_table('dataset_process_rules',
                    sa.Column('id', postgresql.UUID(), server_default=sa.text('uuid_generate_v4()'), nullable=False),
                    sa.Column('dataset_id', postgresql.UUID(), nullable=False),
                    sa.Column('mode', sa.String(length=255), server_default=sa.text("'automatic'::character varying"),
                              nullable=False),
    ...
    op.create_table('datasets',
                    ...
                    sa.Column('provider', sa.String(length=255), server_default=sa.text("'vendor'::character varying"),
                              nullable=False),
                    sa.Column('permission', sa.String(length=255),
                              server_default=sa.text("'only_me'::character varying"), nullable=False),
    ...
    op.create_table('documents',
                    ...
                    sa.Column('indexing_status', sa.String(length=255),
                              server_default=sa.text("'waiting'::character varying"), nullable=False),
                    sa.Column('enabled', sa.Boolean(), server_default=sa.text('true'), nullable=False),
                    sa.Column('disabled_at', sa.DateTime(), nullable=True),
                    sa.Column('disabled_by', postgresql.UUID(), nullable=True),
    ...
    op.create_table('invitation_codes',
                    ...
                    sa.Column('status', sa.String(length=16), server_default=sa.text("'unused'::character varying"),
                              nullable=False),
    ...
    op.create_table('tenants',
                    ...
                    sa.Column('plan', sa.String(length=255), server_default=sa.text("'basic'::character varying"),
                              nullable=False),
                    sa.Column('status', sa.String(length=255), server_default=sa.text("'normal'::character varying"),
                              nullable=False),
                    sa.Column('created_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP(0)'),
