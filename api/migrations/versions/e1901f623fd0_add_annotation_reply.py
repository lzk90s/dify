...
def upgrade():
    ...
    with op.batch_alter_table('app_model_configs', schema=None) as batch_op:
        batch_op.add_column(sa.Column('annotation_reply', sa.JSON(), nullable=True))

    with op.batch_alter_table('dataset_collection_bindings', schema=None) as batch_op:
        batch_op.add_column(
            sa.Column('type', sa.String(length=40), server_default=sa.text("'dataset'::character varying"),
                      nullable=False))
