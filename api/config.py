...
class Config:
    ...
    def __init__(self):
        ...
        db_credentials = {
            ...
            ['DB_TYPE', 'DB_USERNAME', 'DB_PASSWORD', 'DB_HOST', 'DB_PORT', 'DB_DATABASE', 'DB_CHARSET', 'DB_EXTRAS']
        }

        db_extras = f"client_encoding={db_credentials['DB_CHARSET']}&{db_credentials['DB_EXTRAS']}" if db_credentials[
            'DB_CHARSET'] else db_credentials['DB_EXTRAS']

        self.SQLALCHEMY_DATABASE_URI = f"{db_credentials['DB_TYPE']}://{db_credentials['DB_USERNAME']}:{db_credentials['DB_PASSWORD']}@{db_credentials['DB_HOST']}:{db_credentials['DB_PORT']}/{db_credentials['DB_DATABASE']}?{db_extras}"
