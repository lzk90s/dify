...
def upgrade():
    ...
    op.create_table('api_requests',
                    ...
                    sa.Column('api_token_id', UUID(), nullable=False),
    ...
    op.create_table('apps',
                    ...
                    sa.Column('app_model_config_id', UUID(), nullable=True),
    ...
    op.create_table('conversations',
                    sa.Column('id', UUID(), nullable=False),
                    sa.Column('app_id', UUID(), nullable=False),
                    sa.Column('app_model_config_id', UUID(), nullable=False),
                    ...
                    sa.Column('from_end_user_id', UUID(), nullable=True),
                    sa.Column('from_account_id', UUID(), nullable=True),
                    sa.Column('read_at', sa.DateTime(), nullable=True),
                    sa.Column('read_account_id', UUID(), nullable=True),
                    sa.Column('created_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP(0)'),
                              nullable=False),
                    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP(0)'),
                              nullable=False),
    ...
    op.create_table('dataset_queries',
                    ...
                    sa.Column('source_app_id', UUID(), nullable=True),
    ...
    op.create_table('document_segments',
                    ...
                    sa.Column('disabled_by', UUID(), nullable=True),
    ...
    op.create_table('documents',
                    ...
                    sa.Column('paused_by', UUID(), nullable=True),
    ...
    op.create_table('installed_apps',
                    ...
                    sa.Column('tenant_id', UUID(), nullable=False),
                    sa.Column('app_id', UUID(), nullable=False),
                    sa.Column('app_owner_tenant_id', UUID(), nullable=False),
                    sa.Column('position', sa.Integer(), nullable=False),
    ...
    op.create_table('invitation_codes',
                    ...
                    sa.Column('used_by_tenant_id', UUID(), nullable=True),
                    sa.Column('used_by_account_id', UUID(), nullable=True),
    ...
    op.create_table('message_agent_thoughts',
                    ...
                    sa.Column('message_chain_id', UUID(), nullable=False),
                    sa.Column('position', sa.Integer(), nullable=False),
