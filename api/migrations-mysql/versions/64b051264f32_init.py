...
def upgrade():
    ...
    op.create_table('account_integrates',
                    sa.Column('id', sa.String(length=64), server_default=sa.text('(UUID())'), nullable=False),
    ...
    op.create_table('apps',
                    ...
                    sa.Column('app_model_config_id', sa.String(length=64), nullable=True),
    ...
    op.create_table('conversations',
                    sa.Column('id', sa.String(length=64), server_default=sa.text('(UUID())'), nullable=False),
                    sa.Column('app_id', sa.String(length=64), nullable=False),
                    sa.Column('app_model_config_id', sa.String(length=64), nullable=False),
                    ...
                    sa.Column('from_end_user_id', sa.String(length=64), nullable=True),
                    sa.Column('from_account_id', sa.String(length=64), nullable=True),
                    sa.Column('read_at', sa.DateTime(), nullable=True),
                    sa.Column('read_account_id', sa.String(length=64), nullable=True),
                    sa.Column('created_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP(0)'),
                              nullable=False),
                    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP(0)'),
                              nullable=False),
    ...
    with op.batch_alter_table('conversations', schema=None) as batch_op:
        batch_op.create_index('conversation_app_from_user_idx', ['app_id', 'from_source', 'from_end_user_id'],
                              unique=False)
    ...
    op.create_table('dataset_queries',
                    ...
                    sa.Column('source_app_id', sa.String(length=64), nullable=True),
    ...
    op.create_table('datasets',
                    ...
                    sa.Column('permission', sa.String(length=255),
                              server_default=sa.text("'only_me'"), nullable=False),
    ...
    op.create_table('documents',
                    ...
                    sa.Column('dataset_process_rule_id', sa.String(length=64), nullable=True),
                    sa.Column('batch', sa.String(length=255), nullable=False),
                    sa.Column('name', sa.String(length=255), nullable=False),
                    sa.Column('created_from', sa.String(length=255), nullable=False),
                    sa.Column('created_by', sa.String(length=64), nullable=False),
                    sa.Column('created_api_request_id', sa.String(length=64), nullable=True),
                    sa.Column('created_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP(0)'),
                              nullable=False),
                    ...
                    sa.Column('indexing_status', sa.String(length=255),
                              server_default=sa.text("'waiting'"), nullable=False),
                    sa.Column('enabled', sa.Boolean(), server_default=sa.text('true'), nullable=False),
                    sa.Column('disabled_at', sa.DateTime(), nullable=True),
                    sa.Column('disabled_by', sa.String(length=64), nullable=True),
    ...
    op.create_table('installed_apps',
                    ...
                    sa.Column('tenant_id', sa.String(length=64), nullable=False),
                    sa.Column('app_id', sa.String(length=64), nullable=False),
                    sa.Column('app_owner_tenant_id', sa.String(length=64), nullable=False),
                    sa.Column('position', sa.Integer(), nullable=False),
    ...
    op.create_table('invitation_codes',
                    ...
                    sa.Column('used_by_tenant_id', sa.String(length=64), nullable=True),
                    sa.Column('used_by_account_id', sa.String(length=64), nullable=True),
    ...
    op.create_table('message_agent_thoughts',
                    ...
                    sa.Column('message_chain_id', sa.String(length=64), nullable=False),
                    sa.Column('position', sa.Integer(), nullable=False),
    ...
    with op.batch_alter_table('message_feedbacks', schema=None) as batch_op:
        ...
        batch_op.create_index('message_feedback_conversation_idx', ['conversation_id', 'from_source', 'rating'],
                              unique=False)
    ...
    with op.batch_alter_table('pinned_conversations', schema=None) as batch_op:
        batch_op.create_index('pinned_conversation_conversation_idx', ['app_id', 'conversation_id', 'created_by'],
                              unique=False)
