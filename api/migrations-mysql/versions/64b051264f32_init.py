...
def upgrade():
    ...
    op.create_table('app_model_configs',
                    ...
                    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP(0)'),
                              nullable=False, comment='更新时间'),
                    sa.Column('opening_statement', sa.String(length=255), nullable=True,
                              server_default=sqltype.empty_text(),
                              comment='开放状态'),
                    sa.Column('suggested_questions', sa.String(length=255), nullable=True,
                              server_default=sqltype.empty_text(),
                              comment='建议问题'),
                    sa.Column('suggested_questions_after_answer', sa.String(length=255), nullable=True,
                              server_default=sqltype.empty_text(), comment='回答后建议的问题'),
                    sa.Column('more_like_this', sa.String(length=255), nullable=True,
                              server_default=sqltype.empty_text(),
                              comment='更多类似的内容'),
                    sa.Column('model', sa.String(length=2048), nullable=True, server_default=sqltype.empty_text(),
                              comment='模型配置'),
                    sa.Column('user_input_form', sa.String(length=1024), nullable=True,
                              server_default=sqltype.empty_text(),
                              comment='用户输入表单'),
                    sa.Column('pre_prompt', sa.String(length=1024), nullable=True, server_default=sqltype.empty_text(),
                              comment='预置提示'),
                    sa.Column('agent_mode', sa.String(length=255), nullable=True, server_default=sqltype.empty_text(),
                              comment='代理模式'),
    ...
    op.create_table('conversations',
                    ...
                    sa.Column('override_model_configs', sa.String(length=2048), nullable=True,
                              server_default=sqltype.empty_text(), comment='覆盖模型配置'),
                    sa.Column('model_id', sa.String(length=255), nullable=False, comment='模型id'),
                    sa.Column('mode', sa.String(length=255), nullable=False, comment='模式'),
    ...
    op.create_table('message_agent_thoughts',
                    ...
                    sa.Column('position', sa.Integer(), nullable=False, comment='位置'),
                    sa.Column('thought', sa.String(length=255), nullable=True, server_default=sqltype.empty_text(),
                              comment='想法'),
                    ...
                    sa.Column('tool_input', sa.String(length=255), nullable=True, server_default=sqltype.empty_text(),
                              comment='工具输入'),
                    sa.Column('observation', sa.String(length=255), nullable=True, server_default=sqltype.empty_text(),
                              comment='观察'),
    ...
    op.create_table('messages',
                    ...
                    sa.Column('model_provider', sa.String(length=255), nullable=False, comment='模型提供方'),
                    sa.Column('model_id', sa.String(length=255), nullable=False, comment='模型ID'),
                    sa.Column('override_model_configs', sa.String(length=2048), nullable=True, comment='模型配置重写'),
                    sa.Column('conversation_id', UUID(), nullable=False, comment='对话ID'),
                    sa.Column('inputs', sa.JSON(), nullable=True, comment='输入'),
