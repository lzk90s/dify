...
def upgrade():
    ...
    with op.batch_alter_table('app_annotation_hit_histories', schema=None) as batch_op:
        batch_op.add_column(sa.Column('annotation_question', sa.String(length=255), nullable=False, comment='注解问题'))
        batch_op.add_column(sa.Column('annotation_content', sa.String(length=2048), nullable=False, comment='注解内容'))
