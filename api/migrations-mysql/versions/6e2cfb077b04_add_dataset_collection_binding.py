...
def upgrade():
    ...
    op.create_table('dataset_collection_bindings',
                    ...
                    sa.Column('collection_name', sa.String(length=64), nullable=False, comment='集合名'),
    ...
    with op.batch_alter_table('dataset_collection_bindings', schema=None) as batch_op:
        batch_op.create_index('idx_provider_model_name', ['provider_name', 'model_name'], unique=False)

    with op.batch_alter_table('datasets', schema=None) as batch_op:
        batch_op.add_column(sa.Column('collection_binding_id', UUID(), nullable=True))
